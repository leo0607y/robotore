...
const uint32_t end_adress_sector6 	 = 	0x805FFFF; //end address
const uint32_t start_adress_sector7  = 	0x8060000; //sentor7 start address
const uint32_t end_adress_sector7 	 = 	0x807FFFF; //end address
const uint32_t start_adress_sector8  = 	0x8080000; //sentor8 start address
const uint32_t end_adress_sector8 	 = 	0x809FFFF; //end address
const uint32_t start_adress_sector9  = 	0x80A0000; //sentor9 start address
const uint32_t end_adress_sector9 	 = 	0x80BFFFF; //end address
const uint32_t start_adress_sector10 =  0x80C0000; //sentor10 start address
const uint32_t end_adress_sector10 	 = 	0x80DFFFF; //end address
